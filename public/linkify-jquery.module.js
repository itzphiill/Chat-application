...
function linkifyElement(element, opts) {
  ...
  try {
    doc = doc || document || window && window.document || commonjsGlobal && commonjsGlobal.document;
  } catch (e) {
    /* do nothing for now */
  }
...
var linkifyElement_1 = linkifyElement;
...
function apply($) {
  ...
  function jqLinkify(opts) {
    opts = linkifyElement_1.normalize(opts);
    return this.each(function () {
      linkifyElement_1.helper(this, opts, doc);
    });
  }
  ...
  $(function () {
    $('[data-linkify]').each(function () {
      ...
      options = linkifyElement_1.normalize(options);
...
try {
  window.linkifyElement = linkifyElement_1;
} catch (e) {
  /**/
}
